...
<h1 align="center">lxzbot</h1>


[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/ZeronoC/cobain)
...
```bash
git clone https://github.com/dzee22/LXZ
cd LXZ
npm i
npm update
node .
...
```bash
git clone https://github.com/ariffb25/LXZ --branch termux
cd LXZ
npm i
npm update
node .
